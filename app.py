...
BUSINESS_VIEW_ROLES = FINANCE_APPROVAL_ROLES | FINANCE_RECORD_ROLES
BUSINESS_RECORD_ROLES = FINANCE_RECORD_ROLES

# Blueprint boundary: Treasurer records; Chairperson approves/oversees.
# Vice Chairpersons do not receive the finance workspace.
FINANCE_VIEW_ROLES = FINANCE_APPROVAL_ROLES | FINANCE_RECORD_ROLES
